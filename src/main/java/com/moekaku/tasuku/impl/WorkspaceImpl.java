...
public class WorkspaceImpl implements Workspace {
    ...
    public void newCommandTask(String taskName, List<String> dependencies, Runnable action) {
        ...
        tasks.put(resolveName(taskName),
                new CommandTask(this, taskName, dependencies, action));
        modified = true;
    }
    ...
    public void newFileTask(String taskName, List<String> dependencies, Runnable action) {
        ...
        dependencies.forEach(this::newPlaceholderTask);
        tasks.put(resolveName(taskName),
                new FileTask(this, taskName, dependencies, action, loggerFactory));
        modified = true;
    }
    ...
    public void newPlaceholderTask(String taskName) {
        ...
        if (!taskExists(taskName)) {
            tasks.put(resolveName(taskName), new PlaceholderTask(this, taskName));
            modified = true;
        }
    }
